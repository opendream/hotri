...
static const yytype_int8 yyrhs[] =
{
      ...
      40,    39,    37,    34,    32,    -1,    35,     4,    -1,    -1,
       5,    -1,     6,    -1,     7,    -1,     8,    -1,    37,    18,
      41,    -1,    37,    18,    41,    38,    41,    -1,    -1,    15,
      -1,    14,    -1,    19,    -1,     9,    -1,    10,    -1,    11,
      -1,    12,    -1,    15,    -1,    14,    -1,    19,    -1,     9,
      -1,    10,    -1,    11,    -1,    12,    -1,     3,    -1,    41,
      -1,     4,    -1,     3,    -1,     5,    -1,     6,    -1,     7,
      -1,     8,    -1,    13,    -1
};
...
{
       0,    60,    60,    60,    70,    71,    73,    74,    76,    78,
      79,    86,    88,    88,    94,    94,   103,   105,   105,   120,
     120,   127,   134,   134,   144,   151,   158,   158,   158,   158,
     160,   169,   178,   184,   185,   186,   187,   188,   189,   190,
     194,   195,   196,   197,   198,   199,   200,   201,   205,   208,
...
{
  "$end", "error", "$undefined", "DOTTERM", "TERM", "AND", "OR", "NOT",
  "PROX", "GE", "LE", "NE", "EXACT", "SORTBY", "'>'", "'='", "'('", "')'",
  "'/'", "'<'", "$accept", "top", "@1", "sortby", "sortSpec", "singleSpec",
  "cqlQuery1", "cqlQuery", "@2", "@3", "scopedClause", "@4",
  "searchClause", "@5", "@6", "extraTerms", "boolean", "modifiers",
  "mrelation", "relation", "index", "searchTerm", 0
};
#endif
