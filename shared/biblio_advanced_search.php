 ...
 */
  ...
  if ($sType == OBIB_ADVANCED_SEARCH) {
    if (isset($_POST["materialCd"])) {
      $words = array("biblio.material_cd" => $_POST["materialCd"]);
    }
  }
...
<!--**************************************************************************
    ...
    ************************************************************************** -->
<form name="changePageForm" method="POST" action="../shared/biblio_advanced_search.php">
